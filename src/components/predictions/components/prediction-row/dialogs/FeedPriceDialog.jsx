...
export function FeedPriceDialog({ res, usr, _backingAssetID, isExpired, statusKey, settlementFundRaw, prizePoolRaw, relevantBitassetData, t }) {
  ...
  const settlementFund = Number(prizePoolRaw ?? settlementFundRaw ?? relevantBitassetData?.settlement_fund ?? 0);
