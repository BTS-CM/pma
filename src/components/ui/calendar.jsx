  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn("select-none font-medium text-foreground/80", captionLayout === "label"
          ? "text-sm"
        ...
        disabled: cn("text-muted-foreground/60", defaultClassNames.disabled),
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          ...
          const base = cn("size-4 text-foreground/80", className);
          if (orientation === "left") {
