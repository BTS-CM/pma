        ...
        return (
          <Dialog key={`${type}Dialog${index}`}>
            <DialogTrigger asChild>
              <button
                type="button"
                className="grid grid-cols-4 gap-2 w-full text-left px-3 py-1.5 text-xs font-mono tabular-nums border-b border-border/40 hover:bg-accent/40 transition-colors cursor-pointer"
              ...
              >
                ...
                <div className="text-right text-muted-foreground/80">{res.paying}</div>
            ...
            >
              <DialogHeader>
                <div className="flex items-center gap-2">
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-border dark:border-white/15 bg-accent/40 text-foreground/70">
              ...
              <div className="mt-3 space-y-3">
                <div className="rounded-lg border border-border bg-accent/20 p-3">
                  ...
                  <ScrollArea className="h-72 rounded-md border border-border text-xs">
                    <pre className="text-foreground/80 p-2">{JSON.stringify(res, null, 2)}</pre>
                  </ScrollArea>
                </div>
                <div className="text-left">
                  <a href={`/order.html?id=${res.id}`}>
                    <Button className="mt-2 mr-2 gap-2 bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 text-foreground hover:brightness-110 active:scale-[0.99] transition-all">
